                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="{{ route('mindex') }}" class="d-block" wire:navigate>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="{{ route('iindex') }}" class="d-block" wire:navigate>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="{{ route('agropindex') }}" class="d-block" wire:navigate>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="{{ route('ivesindex') }}" class="d-block" wire:navigate>
        ...
        <section class="section-padding" id="section_3">
            <div class="container">
                            ...
                            <div class="custom-block-wrap">
                                <div class="custom-block">
                                    ...
                                    <a href="{{ route('agriproject.show', ['id' => $project->id]) }}"
                                        class="custom-btn btn" wire:navigate>Invest now</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="col-lg-5 col-md-5 col-12 m-auto mt-4">
                    <a class="nav-link custom-btn custom-border-btn btn" href="{{ route('agropindex') }}"
                        wire:navigate>See more</a>
                </div>
            </div>
        </section>
